...
const navLinks = [
  ...
  { to: '/patient/appointments', label: 'My Appointments', exact: false },
  { to: '/patient/prescriptions', label: 'My Prescriptions', exact: false },
  { to: '/patient/reports', label: 'My Reports', exact: false },
]

export default function PatientLayout({ children, onBookAppointment }) {
